...
def process_files(cyto_folder, kars_folder, data_folder, output_folder):
    ...
    for i, (cyto_file, kars_file, data_file) in enumerate(zip(cyto_files, kars_files, data_files)):
...
process_files(cyto_folder, kars_folder, data_folder, output_folder)
